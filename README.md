...
Peripheral Interface: Utilizes a UART module to receive commands (Jump, Duck) from a serial terminal and displays current score and persistent high score on 7-segment displays (HEX).
